...
add.state <- function(A) {
  ...
  add.node.children("parameter", attrs=c(id=bdcGrowthID(), name="stateNode", lower="1.0E-99", upper="1.0E99"), children=value)
  value <- ifelse(bdc$growthrate$kind == "FixedValue", bdc$reldeath$par1, "0.5")
  add.node.children("parameter", attrs=c(id=bdcRelDeathID(), name="stateNode", lower="0.0", upper="1.0"), children=value)
  value <- ifelse(bdc$w$kind == "FixedValue", bdc$w$par1, "0.5")
  add.node.children("parameter", attrs=c(id=bdcCollapseWtID(), name="stateNode", lower="0.0", upper="1.0"), children=value)
  add.comment("The origin height of the smcTree. Must be estimated. Initial value ignored.")
  add.node.children("parameter", attrs=c(id=bdcOriginHtID(), name="stateNode", lower="1.0E-99", upper="1.0E99"), children="1")
  ...
  add.node.children("parameter", attrs=c(id=popSFID(), name="stateNode", lower="1.0E-99", upper="1.0E99"), children=value)
  ...
  if (length(clocks) > 1) {
    for (c in 2:length(clocks)) {
      add.node.children("parameter", attrs=c(id=clockRateID.c(c), name="stateNode"), children="1.0")
    }
  }
  ...
  for (u in 1:length(siteMs)) {
    add.node.children("parameter", attrs=c(id=kappaID.u(u), name="stateNode"), children="2.0")
    attrs <- c(id=frequenciesParamID.u(u), name="stateNode", dimension="4", lower="0.0", upper="1.0")
    add.node.children("parameter", attrs=attrs, children="0.25")
  }
